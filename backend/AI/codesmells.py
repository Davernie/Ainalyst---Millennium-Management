...
with open("snippet.py", "r") as file:
    codeinput = file.read()

codesmells = litellm.completion(
    model="gpt-4o-mini",
    messages=[
        {"role": "system", "content": "You analyze code snippets for common code smells and provide suggestions for improvement."},
...
print(codesmells["choices"][0]["message"]["content"])